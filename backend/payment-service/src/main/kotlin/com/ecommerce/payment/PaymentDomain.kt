...
@Serializable
enum class PaymentProviderName { HTTP, COD }
...
@Serializable
data class PaymentCreateRequest(val orderId: String, val amountMinor: Long, val currency: String, val provider: PaymentProviderName, val paymentMethodToken: String, val returnUrl: String? = null)
@Serializable
...
data class ProviderCreateRequest(val paymentId: String, val orderId: String, val amountMinor: Long, val currency: String, val paymentMethodToken: String, val returnUrl: String?)
